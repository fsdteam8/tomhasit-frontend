  ...
  const { data: gallery } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(
        `https://tomhasit-backend-1.onrender.com/api/v1/gallery/all-galleries`
      );
            ...
            (
              ...
              <Link href="/gallery" key={index}>
                ...
                >
                  ...
                  <div className="absolute text-center place-content-center text-white font-bold lg:text-lg text-base inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-4">
